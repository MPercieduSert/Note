...
\lien{Exercice.south east}{original.south}{\begin{tabular}{c}dérivée\\$0-N$\end{tabular}}
\lien{Exercice.north east}{original.north}{\begin{tabular}{c}initial\\$0-1$\end{tabular}}
